...
describe('Service Story Task',function(){
	...
	this.timeout(100000);
		...
		it('GET /projects/{project_id}/stories/{story_id}/tasks', function (done) {
			...
			var storyId=-1;
			var taskId=-1;
			var prj={name:'Project107878500'};
			var story={name:"As a tester verify the API is implemented"};
			var task={description:"Verify the request 200 OK"};
			postProject
		...
		it('GET /projects/{project_id}/stories/{story_id}/tasks/{task_id}', function (done) {
			...
			var storyId=-1;
			var taskId=-1
			var prj={name:'Project1585234000'};
			var story={name:"As a tester verify the API is implemented"};
			var task={description:"Verify the request 200 OK"};
			postProject
			.createProject(prj,function (res) {
		...
		it('PUT /projects/{project_id}/stories/{story_id}/tasks/{task_id}', function (done) {
			...
			var storyId=-1;
			var taskId=-1
			var prj={name:'Project847485411000'};
			var story={name:"As a tester verify the API is implemented"};
			var task={description:"Verify the request 200 OK"};
			var taskEdited={description:"Verify the request 204 Delete Object"};
			postProject
			.createProject(prj,function (res) {
				expect(res.status).to.equal(200);
				prjId=res.body.id;
		...
		it('DELETE /projects/{project_id}/stories/{story_id}/tasks/{task_id}', function (done) {
			...
			var storyId=-1;
			var taskId=-1
			var prj={name:'Project8743358000'};
			var story={name:"As a tester verify the API is implemented"};
			var task={description:"Verify the request 200 OK"};
