...
var getStoryOwner = function(projectId, storyId, token, callback) {
	var storyOwnersEndPoint = endPoint.storyOwnersEndPoint.replace('{project_id}', projectId)+'/'+endPoint.storyOwnersEndPoint.replace('{story_id}', storyId);console.log('END POINT'+storyOwnersEndPoint);
	request
